  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100">Absence History</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">View all your recorded absences</p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-4 gap-6">
        <Card className="p-6 border border-gray-200 dark:border-[#222] dark:bg-[#111111] rounded-2xl">
          <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">Total Absences</p>
          <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">4</p>
        </Card>
        <Card className="p-6 border border-gray-200 dark:border-[#222] dark:bg-[#111111] rounded-2xl">
        ...
        <Card className="p-6 border border-gray-200 dark:border-[#222] dark:bg-[#111111] rounded-2xl">
          <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">Total Emails Sent</p>
          <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">450</p>
        </Card>
      </div>
      ...
      <Card className="p-6 border border-gray-200 dark:border-[#222] dark:bg-[#111111] rounded-2xl overflow-hidden">
        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-6">Absence Records</h2>

        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 dark:border-[#222]">
                <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-gray-200 text-sm">Date</th>
                <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-gray-200 text-sm">Periods</th>
                <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-gray-200 text-sm">Reason</th>
            ...
            <tbody>
              {absenceRecords.map((record) => (
                <tr key={record.id} className="border-b border-gray-100 dark:border-[#222] hover:bg-gray-50 dark:hover:bg-[#1a1a1a] transition-colors">
                  ...
                  <td className="py-4 px-4">
                    <span className="text-gray-700 dark:text-gray-300 text-sm">{record.reason}</span>
                  </td>
                  <td className="py-4 px-4">
                    <Badge
                      style={{
                  ...
                  <td className="py-4 px-4">
                    <span className="text-gray-900 dark:text-gray-100 font-medium">{record.emailsSent}</span>
                  </td>
                  <td className="py-4 px-4">
                    <Button
                      variant="outline"
      ...
      {/* Notes Section */}
      <Card className="p-6 border border-gray-200 dark:border-red-500/20 rounded-2xl bg-red-50 dark:bg-red-500/5 border-red-200 dark:border-red-500/20">
        <div className="flex items-start gap-3">
          <FileText className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
          <div>
            <h3 className="font-semibold text-red-900 dark:text-red-400">How absences work</h3>
            <ul className="text-sm text-red-800 dark:text-red-300/80 mt-2 space-y-1">
